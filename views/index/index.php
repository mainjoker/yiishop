...
$this->title="首页_慕课商城";
$this->registerJsFile('assets/js/jquery-1.10.2.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/jquery-migrate-1.2.1.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/bootstrap.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/gmap3.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/bootstrap-hover-dropdown.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/owl.carousel.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/css_browser_selector.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/echo.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/jquery.easing-1.3.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/bootstrap-slider.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/jquery.raty.min.js',['position'=>\yii\web\view::POS_HEAD]);  
$this->registerJsFile('assets/js/jquery.prettyPhoto.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/jquery.customSelect.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js/wow.min.js',['position'=>\yii\web\view::POS_HEAD]);
$this->registerJsFile('assets/js//scripts.js',['position'=>\yii\web\view::POS_HEAD]); 
?>
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <?php foreach ($this->params['menu'] as $key => $val): ?>
            ...
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $val['title'] ?></a>
    ...
    <div class="col-xs-12 col-lg-4">
        <ul>
            <?php foreach ($val['children'] as $k => $v): ?>
                <li><a href="<?php echo yii\helpers\Url::to(['product/list','cateid'=>$v['cateid']]) ?>"><?php echo $v['title'] ?></a></li>
            <?php endforeach ?>
        </ul>
    </div>
</div>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="featured">
                    <div class="product-grid-holder">
                        <?php foreach ($model['tui'] as $key => $val): ?>
                         <a href="<?php echo yii\helpers\Url::to(['product/detail','productid'=>$val['productid']]) ?>">
                          <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                <div class="ribbon red"><span>sale</span></div> 
                                <div class="image">
                                    <!-- <img alt="" src="assets/images/blank.gif" data-echo="assets/images/products/product-01.jpg" /> -->
                                    <img alt="" src="<?php echo 'http://'.$val['cover'] ?>-middle_style" data-echo="<?php echo 'http://'.$val['cover'] ?>-middle_style" />
                                </div>
                                <div class="body">
                                    <div class="label-discount green"><?php echo round($val['saleprice']/$val['price']*100, 0) ?>% sale</div>
                                    <div class="title">
                                        <a href="single-product.html"><?php echo $val['title'] ?></a>
                                    </div>
                                    <div class="brand">sony</div>
                                </div>
                                <div class="prices">
                                    <div class="price-prev"><?php echo $val['saleprice'] ?></div>
                                    <div class="price-current pull-right"><?php echo $val['price'] ?></div>
                                </div>
                ...
                <div class="tab-pane" id="new-arrivals">
                    <div class="product-grid-holder">
                     <?php foreach ($model['new'] as $key => $val): ?>
                     <a href="<?php echo yii\helpers\Url::to(['product/detail','productid'=>$val['productid']]) ?>">
                          <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                            <div class="product-item">
                                <div class="ribbon red"><span>sale</span></div> 
                ...
                <div class="tab-pane" id="top-sales">
                    <div class="product-grid-holder">
                    <?php foreach ($model['hot'] as $key => $val): ?>                    
                        <a href="<?php echo yii\helpers\Url::to(['product/detail','productid'=>$val['productid']]) ?>">
...
<!-- ============================================================= TOP RATED PRODUCTS : END ============================================================= -->            </div><!-- /.col -->
    ...
    <div class="link-list-row">
        <div class="container no-padding">GG
