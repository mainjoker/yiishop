                ...
                <section class="section sign-in inner-right-xs">
                    ...
                    <?php $form=ActiveForm::begin(
                        [
                            ...
                            'fieldConfig'=>[
                                'template'=>'<div class="field-row"><label>{input}{error}</label></div>'
                            ]
                        ]
                    ) ?>

                    <?php echo $form->field($model,'username')->textInput(['class'=>'le-input','placeholder'=>"请输入用户名或邮箱"]) ?>
                    <?php echo $form->field($model,'password')->passwordInput(['class'=>'le-input','placeholder'=>"请输入密码"]) ?>
