        ...
        <li>
            <div class="row">
                <div class="col-xs-4 col-sm-4 no-margin">
                    ...
                    <img alt="" src="<?php echo 'http://'.$pro['cover'] ?>-small_style"  />
                    </a>
                </div>
...
<?php foreach($hot as $pro): ?>
        <div class="no-margin carousel-item product-item-holder hover size-medium">
            <div class="product-item">
                ...
                <div class="image">
                <img alt="" src="<?php echo 'http://'.$pro['cover'] ?>-middle_style" />
                </div>
                <div class="body">
                    <div class="title">
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><?php echo $pro['title'] ?></a>
                ...
                <div class="prices">
                <div class="price-current text-right">￥ <?php echo $pro['forsale'] ? $pro['saleprice'] :$pro['price'] ?></div>
                </div>
