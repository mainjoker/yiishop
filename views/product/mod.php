                    ...
                    <div class="row-fluid form-wrapper">
                        ...
                        <div class="span9 with-sidebar">
                            <div class="container">
                                ...
                                echo $form->field($model, 'cateid')->dropDownList($list, ['id' => 'cates','style'=>'height:27px']);
                                ...
                                echo $form->field($model, 'forsale')->radioList([0=>'不促销', 1=>'促销'], ['class' => 'span8']);
                                echo $form->field($model, 'isnew')->radioList([1=>'是', 0=>'否'], ['class' => 'span8'])->label('是否新品');
                                echo $form->field($model, 'isbest')->radioList([1=>'是', 0=>'否'], ['class' => 'span8'])->label('是否精品');
                                echo $form->field($model, 'saleprice')->textInput(['class' => 'span9']);
                                echo $form->field($model, 'num')->textInput(['class' => 'span9']);
                                echo $form->field($model, 'onsale')->radioList(['下架', '上架'], ['class' => 'span8']);
                                echo $form->field($model, 'cover')->fileInput(['class' => 'span9']);

                                if (!empty($model->cover)):
                                ?>
                                 <img src="<?php echo 'http://'.$model->cover;?>-middle_style">
                                    <hr>
                                <?php
                                    endif;
                                ...
                                ?>
                                    <img src="<?php echo 'http://'.$pic ?>-small_style">
