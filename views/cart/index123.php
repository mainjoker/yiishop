              ...
              <div class="row no-margin cart-item">
                <div class="col-xs-12 col-sm-2 no-margin">
                    <a href="#" class="thumb-holder">
                        <img class="lazy" alt="" src="<?php echo "http://".$val['product']['cover'] ?>-middle_style" />
                    </a>
                </div>
                ...
                <div class="col-xs-12 col-sm-5 ">
                    ...
                    <div class="brand"><?php echo $val['product']['tag'] ?></div>
                </div> 
                    ...
                    <div class="quantity">
                        <div class="le-quantity">
                            <form>
                                ...
                                <input name="quantity" readonly="readonly" type="text" value="<?php echo $val['productnum'] ?>" />
                ...
                <div class="col-xs-12 col-sm-2 no-margin">
                    <div class="price">
                        <?php   echo $val['product']['forsale']==1?$val['product']['saleprice']:$val['product']['price'];?>
                    </div>
