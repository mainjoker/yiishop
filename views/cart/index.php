...
<?php foreach((array)$data as $k=>$product): ?>
            <input type="hidden" name="Orderinfo[<?php echo $k?>][productid]" value="<?php echo $product['productid'] ?>">
            <input type="hidden" name="Orderinfo[<?php echo $k?>][price]" value="<?php echo $product['price'] ?>">
            <input type="hidden" name="Orderinfo[<?php echo $k?>][productnum]" value="<?php echo $product['productnum'] ?>">
            <div class="row no-margin cart-item">
                <div class="col-xs-12 col-sm-2 no-margin">
                <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>" class="thumb-holder">
                    <img class="lazy" alt="" src="<?php echo 'http://'.$product['cover'] ?>-middle_style" />
                    </a>
                </div>
                ...
                <div class="col-xs-12 col-sm-3 no-margin">
                    <div class="quantity">
                        <div class="le-quantity">
                                ...
                                <input id="<?php echo $product['cartid'] ?>" readonly="readonly"name="productnum" type="text" value="<?php echo $product['productnum'] ?>" />
...
<script>
    var url="<?php echo yii\helpers\Url::to(['cart/mod']) ?>";
