        ...
        <div id="sidebar-nav">
            <ul id="dashboard-menu">
                <li class="active">
                    ...
                    <a href="<?php echo yii\helpers\Url::to(['/admin/default/index']) ?>">
                        <i class="icon-home"></i>
                        <span>后台首页</span></a>
                </li>
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                        <a href="<?php echo yii\helpers\Url::to(['/admin/manage/managers'])?>">管理员列表</a></li>

                        <li>
                        <a href="<?php echo yii\helpers\Url::to(['/admin/manage/reg'])?>">加入新管理员</a></li>
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="<?php echo yii\helpers\Url::to(['/user/userlist'])?>">用户列表</a></li>
                        <li>
                            <a href="<?php echo yii\helpers\Url::to(['/user/adduser'])?>">加入新用户</a></li>
                    </ul>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="<?php echo yii\helpers\Url::To(['/category/index']) ?>">分类列表</a></li>
                        <li>
                            <a href="<?php echo yii\helpers\Url::To(['/category/add']) ?>">加入分类</a></li>
                    </ul>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="<?php echo yii\helpers\Url::to(['/product/index'],true) ?>">商品列表</a></li>
                        <li>
                            <a href="<?php echo yii\helpers\Url::to(['/product/add'],true) ?>">添加商品</a></li>
                    </ul>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#">
                    ...
                    <ul class="submenu">
                        <li>
                             <a href="<?php echo yii\helpers\Url::to(['/admin/order/list'])?>">订单列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
