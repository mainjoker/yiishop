  ...
  <div class="trade-order-mainClose">
    <div>
      ...
      <table style="width:100%;border-collapse:collapse;border-spacing:0px;">
        ...
        <tbody>
          <?php $i = 1; ?>
          <?php foreach($order->orderinfo as $product): ?>
          <tr>
            <td style="text-align:left;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:0;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;padding-left:20px;" >
              ...
              <a class="tp-tag-a" href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>" style="float:left;width:27%;margin-right:2%;text-align:center;" target="_blank">
                <img src="<?php echo 'http://'.$product['cover'] ?>-small_style" style="border:1px solid #E8E8E8;max-width:80px;">
                </a>
            ...
            <td style="text-align:center;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:1px;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;" >
              <div>
                <div style="font-family:verdana;font-style:normal;">
                  ...
                  <p>
                    <strong>
                        <?php echo $order->express_fee ?> 元
                    </strong>
                  </p>
                  <p><?php echo $order->express; ?></p>
                  <span>
                  </span>
                </div>
                <p>
                ...
                <div>
                  <div style="margin-bottom:3px;position:relative">
                    <span>
                      ...
                      <div class="expressshow" style="display:none;overflow:auto;text-align:left;font-size:12px;width:200px;height:300px;position:absolute;border:1px solid #ccc;padding:15px;background-color:#eee">快递状态</div>
                      </a>
                    </span>
                    <span>
                        <a data="<?php echo $order->ordersn ?>" class="tp-tag-a express" href="#" target="_blank">
                        <span class="trade-operate-text">
                          查看物流
                        </span>
                      <div class="expressshow" style="display:none;overflow:auto;text-align:left;font-size:12px;width:200px;height:300px;position:absolute;border:1px solid #ccc;padding:15px;background-color:#eee">查询中...</div>
                      </a>
                    </span>
                  </div>
                <?php endif; ?>
                <?php else: ?>
                    <td style="text-align:center;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:1px;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;" >123</td>
                    <td style="text-align:center;vertical-align:top;padding-top:10px;padding-bottom:10px;border-right-width:1px;border-right-style:solid;border-right-color:#E8E8E8;border-top-width:0;border-top-style:solid;border-top-color:#E8E8E8;" >321</td>
                <?php endif; ?>
                </div>
              </div>
            </td>
