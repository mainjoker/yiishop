                    ...
                    <div class="row no-margin order-item">
                        ...
                        <div class="title">
                            ...
                            <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $product['productid']]) ?>" class="thumb-holder">
                                <img class="lazy" alt="" src="<?php echo 'http://'.$product['cover'] ?>-small_style" />
                            </a>
                ...
                <div class="col-xs-12 col-lg-4 col-lg-offset-8 no-margin-right">
                    <div id="subtotal-holder">
                        ...
                        <ul id="total-field" class="tabled-data inverse-bold ">
                            <li>
                                <label>订单总额</label>
                                <div class="value" style="width:100%;text-align:right" id="total1">￥ <span><?php echo $total+20;?></span></div>
                            </li>
                        </ul><!-- /.tabled-data -->
...
if (addressid==false) {
    $("input[name=addressid]").val($("input[name=address]").val());
}
</script>
<?php ActiveForm::end(); ?>
<?php
